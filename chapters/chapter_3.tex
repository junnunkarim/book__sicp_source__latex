...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.1}Exercise 3.1:} An \newterm{accumulator} is a
...
\exerciseHeading{\phantomsection\label{Exercise 3.2}Exercise 3.2:} In software-testing applications,
...
\exerciseHeading{\phantomsection\label{Exercise 3.3}Exercise 3.3:} Modify the \code{make-account}
...
\exerciseHeading{\phantomsection\label{Exercise 3.4}Exercise 3.4:} Modify the \code{make-account}
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.5}Exercise 3.5:} \newterm{Monte Carlo integration}
...
\exerciseHeading{\phantomsection\label{Exercise 3.6}Exercise 3.6:} It is useful to be able to reset a
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.7}Exercise 3.7:} Consider the bank account objects
...
\exerciseHeading{\phantomsection\label{Exercise 3.8}Exercise 3.8:} When we defined the evaluation
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.9}Exercise 3.9:} In \link{Section 1.2.1} we used the
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.10}Exercise 3.10:} In the \code{make-withdraw}
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.11}Exercise 3.11:} In \link{Section 3.2.3} we saw how
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.12}Exercise 3.12:} The following procedure for
...
\exerciseHeading{\phantomsection\label{Exercise 3.13}Exercise 3.13:} Consider the following
...
\exerciseHeading{\phantomsection\label{Exercise 3.14}Exercise 3.14:} The following procedure is quite
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.15}Exercise 3.15:} Draw box-and-pointer diagrams to
explain the effect of \code{set-to-wow!} on the structures \code{z1} and
\code{z2} above.

\exerciseHeading{\phantomsection\label{Exercise 3.16}Exercise 3.16:} Ben Bitdiddle decides to write a
...
\exerciseHeading{\phantomsection\label{Exercise 3.17}Exercise 3.17:} Devise a correct version of the
...
\exerciseHeading{\phantomsection\label{Exercise 3.18}Exercise 3.18:} Write a procedure that examines a
...
\exerciseHeading{\phantomsection\label{Exercise 3.19}Exercise 3.19:} Redo \link{Exercise 3.18} using an
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.20}Exercise 3.20:} Draw environment diagrams to
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.21}Exercise 3.21:} Ben Bitdiddle decides to test the
...
\exerciseHeading{\phantomsection\label{Exercise 3.22}Exercise 3.22:} Instead of representing a queue
...
\exerciseHeading{\phantomsection\label{Exercise 3.23}Exercise 3.23:} A \newterm{deque} (``double-ended
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.24}Exercise 3.24:} In the table implementations
...
\exerciseHeading{\phantomsection\label{Exercise 3.25}Exercise 3.25:} Generalizing one- and
...
\exerciseHeading{\phantomsection\label{Exercise 3.26}Exercise 3.26:} To search a table as implemented
...
\exerciseHeading{\phantomsection\label{Exercise 3.27}Exercise 3.27:} \newterm{Memoization} (also
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.28}Exercise 3.28:} Define an or-gate as a primitive
function box.  Your \code{or-gate} constructor should be similar to
\code{and-gate}.

\exerciseHeading{\phantomsection\label{Exercise 3.29}Exercise 3.29:} Another way to construct an
...
\exerciseHeading{\phantomsection\label{Exercise 3.30}Exercise 3.30:} \link{Figure 3.27} shows a
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.31}Exercise 3.31:} The internal procedure
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.32}Exercise 3.32:} The procedures to be run during
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.33}Exercise 3.33:} Using primitive multiplier,
...
\exerciseHeading{\phantomsection\label{Exercise 3.34}Exercise 3.34:} Louis Reasoner wants to build a
...
\exerciseHeading{\phantomsection\label{Exercise 3.35}Exercise 3.35:} Ben Bitdiddle tells Louis that
...
\exerciseHeading{\phantomsection\label{Exercise 3.36}Exercise 3.36:} Suppose we evaluate the following
...
\exerciseHeading{\phantomsection\label{Exercise 3.37}Exercise 3.37:} The
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.38}Exercise 3.38:} Suppose that Peter, Paul, and
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.39}Exercise 3.39:} Which of the five possibilities
...
\exerciseHeading{\phantomsection\label{Exercise 3.40}Exercise 3.40:} Give all possible values of
...
\exerciseHeading{\phantomsection\label{Exercise 3.41}Exercise 3.41:} Ben Bitdiddle worries that it
...
\exerciseHeading{\phantomsection\label{Exercise 3.42}Exercise 3.42:} Ben Bitdiddle suggests that it's
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.43}Exercise 3.43:} Suppose that the balances in
...
\exerciseHeading{\phantomsection\label{Exercise 3.44}Exercise 3.44:} Consider the problem of
...
\exerciseHeading{\phantomsection\label{Exercise 3.45}Exercise 3.45:} Louis Reasoner thinks our
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.46}Exercise 3.46:} Suppose that we implement
...
\exerciseHeading{\phantomsection\label{Exercise 3.47}Exercise 3.47:} A semaphore (of size \( n \)) is a
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.48}Exercise 3.48:} Explain in detail why the
...
\exerciseHeading{\phantomsection\label{Exercise 3.49}Exercise 3.49:} Give a scenario where the
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.50}Exercise 3.50:} Complete the following
...
\exerciseHeading{\phantomsection\label{Exercise 3.51}Exercise 3.51:} In order to take a closer look at
...
\exerciseHeading{\phantomsection\label{Exercise 3.52}Exercise 3.52:} Consider the sequence of
expressions
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.53}Exercise 3.53:} Without running the program,
...
\exerciseHeading{\phantomsection\label{Exercise 3.54}Exercise 3.54:} Define a procedure
...
\exerciseHeading{\phantomsection\label{Exercise 3.55}Exercise 3.55:} Define a procedure
...
\exerciseHeading{\phantomsection\label{Exercise 3.56}Exercise 3.56:} A famous problem, first raised by
...
\exerciseHeading{\phantomsection\label{Exercise 3.57}Exercise 3.57:} How many additions are performed
...
\exerciseHeading{\phantomsection\label{Exercise 3.58}Exercise 3.58:} Give an interpretation of the
...
\exerciseHeading{\phantomsection\label{Exercise 3.59}Exercise 3.59:} In \link{Section 2.5.3} we saw how
...
\exerciseHeading{\phantomsection\label{Exercise 3.60}Exercise 3.60:} With power series represented as
...
\exerciseHeading{\phantomsection\label{Exercise 3.61}Exercise 3.61:} Let \( S \) be a power series
...
\exerciseHeading{\phantomsection\label{Exercise 3.62}Exercise 3.62:} Use the results of \link{Exercise 3.60}
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.63}Exercise 3.63:} Louis Reasoner asks why the
...
\exerciseHeading{\phantomsection\label{Exercise 3.64}Exercise 3.64:} Write a procedure
...
\exerciseHeading{\phantomsection\label{Exercise 3.65}Exercise 3.65:} Use the series
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.66}Exercise 3.66:} Examine the stream \code{(pairs
...
\exerciseHeading{\phantomsection\label{Exercise 3.67}Exercise 3.67:} Modify the \code{pairs} procedure
...
\exerciseHeading{\phantomsection\label{Exercise 3.68}Exercise 3.68:} Louis Reasoner thinks that
...
\exerciseHeading{\phantomsection\label{Exercise 3.69}Exercise 3.69:} Write a procedure \code{triples}
...
\exerciseHeading{\phantomsection\label{Exercise 3.70}Exercise 3.70:} It would be nice to be able to
...
\exerciseHeading{\phantomsection\label{Exercise 3.71}Exercise 3.71:} Numbers that can be expressed as
...
\exerciseHeading{\phantomsection\label{Exercise 3.72}Exercise 3.72:} In a similar way to \link{Exercise 3.71}
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.73}Exercise 3.73:} We can model electrical circuits
...
\exerciseHeading{\phantomsection\label{Exercise 3.74}Exercise 3.74:} Alyssa P. Hacker is designing a
...
\exerciseHeading{\phantomsection\label{Exercise 3.75}Exercise 3.75:} Unfortunately, Alyssa's
...
\exerciseHeading{\phantomsection\label{Exercise 3.76}Exercise 3.76:} Eva Lu Ator has a criticism of
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.77}Exercise 3.77:} The \code{integral} procedure
...
\exerciseHeading{\phantomsection\label{Exercise 3.78}Exercise 3.78:} Consider the problem of designing
...
\exerciseHeading{\phantomsection\label{Exercise 3.79}Exercise 3.79:} Generalize the \code{solve-2nd}
...
\exerciseHeading{\phantomsection\label{Exercise 3.80}Exercise 3.80:} A \newterm{series RLC circuit}
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 3.81}Exercise 3.81:} \link{Exercise 3.6} discussed
...
\exerciseHeading{\phantomsection\label{Exercise 3.82}Exercise 3.82:} Redo \link{Exercise 3.5} on Monte

...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.1}
\exerciseHeading{Exercise 4.1:} Notice that we cannot tell whether
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.2}
\exerciseHeading{Exercise 4.2:} Louis Reasoner plans to reorder the
...
\phantomsection\label{Exercise 4.3}
\exerciseHeading{Exercise 4.3:} Rewrite \code{eval} so that the
...
\phantomsection\label{Exercise 4.4}
\exerciseHeading{Exercise 4.4:} Recall the definitions of the
...
\phantomsection\label{Exercise 4.5}
\exerciseHeading{Exercise 4.5:} Scheme allows an additional syntax
...
\phantomsection\label{Exercise 4.6}
\exerciseHeading{Exercise 4.6:} \code{let} expressions are derived
expressions, because
...
\phantomsection\label{Exercise 4.7}
\exerciseHeading{Exercise 4.7:} \code{let*} is similar to
...
\phantomsection\label{Exercise 4.8}
\exerciseHeading{Exercise 4.8:} ``Named \code{let}'' is a variant
...
\phantomsection\label{Exercise 4.9}
\exerciseHeading{Exercise 4.9:} Many languages support a variety of
...
\phantomsection\label{Exercise 4.10}
\exerciseHeading{Exercise 4.10:} By using data abstraction, we
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.11}
\exerciseHeading{Exercise 4.11:} Instead of representing a frame
...
\phantomsection\label{Exercise 4.12}
\exerciseHeading{Exercise 4.12:} The procedures
...
\phantomsection\label{Exercise 4.13}
\exerciseHeading{Exercise 4.13:} Scheme allows us to create new
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.14}
\exerciseHeading{Exercise 4.14:} Eva Lu Ator and Louis Reasoner
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.15}
\exerciseHeading{Exercise 4.15:} Given a one-argument procedure
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.16}
\exerciseHeading{Exercise 4.16:} In this exercise we implement the
...
\phantomsection\label{Exercise 4.17}
\exerciseHeading{Exercise 4.17:} Draw diagrams of the environment
...
\phantomsection\label{Exercise 4.18}
\exerciseHeading{Exercise 4.18:} Consider an alternative strategy
...
\phantomsection\label{Exercise 4.19}
\exerciseHeading{Exercise 4.19:} Ben Bitdiddle, Alyssa P. Hacker,
...
\phantomsection\label{Exercise 4.20}
\exerciseHeading{Exercise 4.20:} Because internal definitions look
...
\phantomsection\label{Exercise 4.21}
\exerciseHeading{Exercise 4.21:} Amazingly,
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.22}
\exerciseHeading{Exercise 4.22:} Extend the evaluator in this
section to support the special form \code{let}.  (See \link{Exercise 4.6}.)

\phantomsection\label{Exercise 4.23}
\exerciseHeading{Exercise 4.23:} Alyssa P. Hacker doesn't
...
\phantomsection\label{Exercise 4.24}
\exerciseHeading{Exercise 4.24:} Design and carry out some
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.25}
\exerciseHeading{Exercise 4.25:} Suppose that (in ordinary
...
\phantomsection\label{Exercise 4.26}
\exerciseHeading{Exercise 4.26:} Ben Bitdiddle and Alyssa
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.27}
\exerciseHeading{Exercise 4.27:} Suppose we type in the following
...
\phantomsection\label{Exercise 4.28}
\exerciseHeading{Exercise 4.28:} \code{eval} uses
...
\noindent
\phantomsection\label{Exercise 4.29}
\exerciseHeading{Exercise 4.29:} Exhibit a program that you would
...
\phantomsection\label{Exercise 4.30}
\exerciseHeading{Exercise 4.30:} Cy D. Fect, a reformed C
...
\phantomsection\label{Exercise 4.31}
\exerciseHeading{Exercise 4.31:} The approach taken in this
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.32}
\exerciseHeading{Exercise 4.32:} Give some examples that
...
\phantomsection\label{Exercise 4.33}
\exerciseHeading{Exercise 4.33:} Ben Bitdiddle tests the lazy list
...
\phantomsection\label{Exercise 4.34}
\exerciseHeading{Exercise 4.34:} Modify the driver loop for the
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.35}
\exerciseHeading{Exercise 4.35:} Write a procedure
...
\phantomsection\label{Exercise 4.36}
\exerciseHeading{Exercise 4.36:} \link{Exercise 3.69} discussed how
...
\phantomsection\label{Exercise 4.37}
\exerciseHeading{Exercise 4.37:} Ben Bitdiddle claims that the
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.38}
\exerciseHeading{Exercise 4.38:} Modify the multiple-dwelling
...
\phantomsection\label{Exercise 4.39}
\exerciseHeading{Exercise 4.39:} Does the order of the
...
\phantomsection\label{Exercise 4.40}
\exerciseHeading{Exercise 4.40:} In the multiple dwelling problem,
...
\phantomsection\label{Exercise 4.41}
\exerciseHeading{Exercise 4.41:} Write an ordinary Scheme program
to solve the multiple dwelling puzzle.

\phantomsection\label{Exercise 4.42}
\exerciseHeading{Exercise 4.42:} Solve the following ``Liars''
...
\phantomsection\label{Exercise 4.43}
\exerciseHeading{Exercise 4.43:} Use the \code{amb} evaluator to
...
\phantomsection\label{Exercise 4.44}
\exerciseHeading{Exercise 4.44:} \link{Exercise 2.42} described the
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.45}
\exerciseHeading{Exercise 4.45:} With the grammar given above, the
...
\phantomsection\label{Exercise 4.46}
\exerciseHeading{Exercise 4.46:} The evaluators in
...
\phantomsection\label{Exercise 4.47}
\exerciseHeading{Exercise 4.47:} Louis Reasoner suggests that,
...
\phantomsection\label{Exercise 4.48}
\exerciseHeading{Exercise 4.48:} Extend the grammar given above to
...
\phantomsection\label{Exercise 4.49}
\exerciseHeading{Exercise 4.49:} Alyssa P. Hacker is more
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.50}
\exerciseHeading{Exercise 4.50:} Implement a new special form
...
\phantomsection\label{Exercise 4.51}
\exerciseHeading{Exercise 4.51:} Implement a new kind of
...
\phantomsection\label{Exercise 4.52}
\exerciseHeading{Exercise 4.52:} Implement a new construct called
...
\phantomsection\label{Exercise 4.53}
\exerciseHeading{Exercise 4.53:} With \code{permanent\-/set!} as
...
\phantomsection\label{Exercise 4.54}
\exerciseHeading{Exercise 4.54:} If we had not realized that
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.55}
\exerciseHeading{Exercise 4.55:} Give simple queries that retrieve
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.56}
\exerciseHeading{Exercise 4.56:} Formulate compound queries that
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.57}
\exerciseHeading{Exercise 4.57:} Define a rule that says that
...
\phantomsection\label{Exercise 4.58}
\exerciseHeading{Exercise 4.58:} Define a rule that says that a
...
\phantomsection\label{Exercise 4.59}
\exerciseHeading{Exercise 4.59:} Ben Bitdiddle has missed one
...
\phantomsection\label{Exercise 4.60}
\exerciseHeading{Exercise 4.60:} By giving the query
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.61}
\exerciseHeading{Exercise 4.61:} The following rules implement a
...
\phantomsection\label{Exercise 4.62}
\exerciseHeading{Exercise 4.62:} Define rules to implement the
...
\phantomsection\label{Exercise 4.63}
\exerciseHeading{Exercise 4.63:} The following data base (see
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.64}
\exerciseHeading{Exercise 4.64:} Louis Reasoner mistakenly deletes
...
\phantomsection\label{Exercise 4.65}
\exerciseHeading{Exercise 4.65:} Cy D. Fect, looking forward to
...
\phantomsection\label{Exercise 4.66}
\exerciseHeading{Exercise 4.66:} Ben has been generalizing the
...
\phantomsection\label{Exercise 4.67}
\exerciseHeading{Exercise 4.67:} Devise a way to install a loop
...
\phantomsection\label{Exercise 4.68}
\exerciseHeading{Exercise 4.68:} Define rules to implement the
...
\phantomsection\label{Exercise 4.69}
\exerciseHeading{Exercise 4.69:} Beginning with the data base and
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.70}
\exerciseHeading{Exercise 4.70:} What is the purpose of the
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 4.71}
\exerciseHeading{Exercise 4.71:} Louis Reasoner wonders why the
...
\phantomsection\label{Exercise 4.72}
\exerciseHeading{Exercise 4.72:} Why do \code{disjoin} and
...
\phantomsection\label{Exercise 4.73}
\exerciseHeading{Exercise 4.73:} Why does \code{flatten\-/stream}
...
\phantomsection\label{Exercise 4.74}
\exerciseHeading{Exercise 4.74:} Alyssa P. Hacker proposes to use
...
\phantomsection\label{Exercise 4.75}
\exerciseHeading{Exercise 4.75:} Implement for the query language
...
\phantomsection\label{Exercise 4.76}
\exerciseHeading{Exercise 4.76:} Our implementation of \code{and}
...
\phantomsection\label{Exercise 4.77}
\exerciseHeading{Exercise 4.77:} In \link{Section 4.4.3} we saw
...
\phantomsection\label{Exercise 4.78}
\exerciseHeading{Exercise 4.78:} Redesign the query language as a
...
\phantomsection\label{Exercise 4.79}
\exerciseHeading{Exercise 4.79:} When we implemented the Lisp

...
\chapterQuote{%
    ...
    manifold motions are caused by a most simple and material force, just as
    all motions of the clock are caused by a single weight.
  }
  {Johannes Kepler}
...
\noindent
\lettrine{W}{e began this book} by studying processes and by describing processes in terms
...
% figure 5.1
\begin{imageFigure}{Data paths for a \acronym{GCD} machine.}
  \includegraphics[width=58mm]{assets/figures/chapter_5/figure_5.1a.pdf}
\end{imageFigure}
...
% figure 5.2
\begin{imageFigure}{Controller for a \acronym{GCD} machine.}
  \includegraphics[width=41mm]{assets/figures/chapter_5/figure_5.2.pdf}
\end{imageFigure}
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.1}Exercise 5.1:} Design a register machine to
...
% figure 5.3
\begin{codeFigure}{A specification of the \acronym{GCD}
machine.}
\begin{codeBlock}
(data-paths
 (registers
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.2}Exercise 5.2:} Use the register-machine language
...
\begin{imageFigure}
  ...
  \includegraphics[width=107mm]{assets/figures/chapter_5/figure_5.4b.pdf}
\end{imageFigure}
...
\begin{imageFigure}
  ...
  \includegraphics[width=67mm]{assets/figures/chapter_5/figure_5.5a.pdf}
\end{imageFigure}
...
\begin{codeFigure}
  {%
    Controller instruction sequence for the \acronym{GCD} machine in
    \link{Figure 5.5}.
  }%
\begin{codeBlock}
(controller test-b
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.3}Exercise 5.3:} Design a machine to compute square
...
\begin{imageFigure}
  {%
    Portions of the data paths and controller sequence for a \mbox{machine}
    with two \acronym{GCD} computations.
  }%
  \includegraphics[width=105mm]{assets/figures/chapter_5/figure_5.7b.pdf}
\end{imageFigure}
...
\begin{codeFigure}
  {%
    ...
    data-path components for two different \acronym{GCD} computations.
  }%
\begin{codeBlock}
gcd-1
 (test (op =) (reg b) (const 0))
...
\begin{codeFigure}
  {%
    Using a \code{continue} register to avoid the duplicate controller sequence
    in \link{Figure 5.8}.
  }%
\begin{codeBlock}
gcd
...
\begin{codeFigure}
  {%
    Assigning labels to the \code{continue} register simplifies and generalizes
    the strategy shown in \link{Figure 5.9}.
  }%
\begin{codeBlock}
gcd
 (test (op =) (reg b) (const 0))
...
% figure 5.11
\begin{imageFigure}{A recursive factorial machine.}
  \includegraphics[width=106mm]{assets/figures/chapter_5/figure_5.11a.pdf}
\end{imageFigure}
...
% figure 5.12
\begin{codeFigure}{Controller for a machine to compute Fibonacci numbers.}
\begin{codeBlock}
(controller
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.4}Exercise 5.4:} Specify register machines that
...
\exerciseHeading{\phantomsection\label{Exercise 5.5}Exercise 5.5:} Hand-simulate the factorial and
...
\exerciseHeading{\phantomsection\label{Exercise 5.6}Exercise 5.6:} Ben Bitdiddle observes that the
...
\begin{codeBlock}
(assign ~\(\langle \)~~\var{register-name}~~\(\rangle \)~ (reg ~\(\langle \)~~\var{register-name}~~\(\rangle \)~))
(assign ~\(\langle \)~~\var{register-name}~~\(\rangle \)~ (const ~\(\langle \)~~\var{constant-value}~~\(\rangle \)~))
(assign ~\(\langle \)~~\var{register-name}~~\(\rangle \)~
        (op ~\(\langle \)~~\var{operation-name}~~\(\rangle \)~)
        ~\(\langle \)~~\var{input}~~\(_{\mono{1}}\rangle \)~ ~\( \dots \)~ ~\(\langle \)~~\var{input}~~\(_{\monoItalic{n}}\rangle \)~)
(perform (op ~\(\langle \)~~\var{operation-name}~~\(\rangle \)~) ~\(\langle \)~~\var{input}~~\(_{\mono{1}}\rangle \)~ ~\( \dots \)~ ~\(\langle \)~~\var{input}~~\(_{\monoItalic{n}}\rangle \)~)
(test (op ~\(\langle \)~~\var{operation-name}~~\(\rangle \)~) ~\(\langle \)~~\var{input}~~\(_{\mono{1}}\rangle \)~ ~\( \dots \)~ ~\(\langle \)~~\var{input}~~\(_{\monoItalic{n}}\rangle \)~)
(branch (label ~\(\langle \)~~\var{label-name}~~\(\rangle \)~))
(goto (label ~\(\langle \)~~\var{label-name}~~\(\rangle \)~))
\end{codeBlock}
...
\begin{codeBlock}
(assign ~\(\langle \)~~\var{register-name}~~\(\rangle \)~ (label ~\(\langle \)~~\var{label-name}~~\(\rangle \)~))
(goto (reg ~\(\langle \)~~\var{register-name}~~\(\rangle \)~))
\end{codeBlock}
...
\begin{codeBlock}
(save ~\(\langle \)~~\var{register-name}~~\(\rangle \)~)
(restore ~\(\langle \)~~\var{register-name}~~\(\rangle \)~)
\end{codeBlock}
...
\begin{codeBlock}
(make-machine ~\(\langle \)~~\var{register-names}~~\(\rangle \)~
              ~\(\langle \)~~\var{operations}~~\(\rangle \)~
              ~\(\langle \)~~\var{controller}~~\(\rangle \)~)
\end{codeBlock}
...
\begin{codeBlock}
(set-register-contents! ~\(\langle \)~~\var{machine-model}~~\(\rangle \)~
                        ~\(\langle \)~~\var{register-name}~~\(\rangle \)~
...
\begin{codeBlock}
(get-register-contents ~\(\langle \)~~\var{machine-model}~~\(\rangle \)~
                       ~\(\langle \)~~\var{register-name}~~\(\rangle \)~)
\end{codeBlock}
...
\begin{codeBlock}
(start ~\(\langle \)~~\var{machine-model}~~\(\rangle \)~)
\end{codeBlock}
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.7}Exercise 5.7:} Use the simulator to test the
...
\begin{codeFigure}
  {%
    The \code{make\-/new\-/machine} procedure, which implements the basic
    machine model.
  }%
\begin{codeBlock}
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.8}Exercise 5.8:} The following register-machine code
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.9}Exercise 5.9:} The treatment of machine operations
...
\exerciseHeading{\phantomsection\label{Exercise 5.10}Exercise 5.10:} Design a new syntax for
...
\exerciseHeading{\phantomsection\label{Exercise 5.11}Exercise 5.11:} When we introduced \code{save}
...
\exerciseHeading{\phantomsection\label{Exercise 5.12}Exercise 5.12:} The simulator can be used to help
...
\exerciseHeading{\phantomsection\label{Exercise 5.13}Exercise 5.13:} Modify the simulator so that it
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.14}Exercise 5.14:} Measure the number of pushes and
...
\exerciseHeading{\phantomsection\label{Exercise 5.15}Exercise 5.15:} Add \newterm{instruction
...
\exerciseHeading{\phantomsection\label{Exercise 5.16}Exercise 5.16:} Augment the simulator to provide
...
\exerciseHeading{\phantomsection\label{Exercise 5.17}Exercise 5.17:} Extend the instruction tracing of
...
\exerciseHeading{\phantomsection\label{Exercise 5.18}Exercise 5.18:} Modify the \code{make\-/register}
...
\exerciseHeading{\phantomsection\label{Exercise 5.19}Exercise 5.19:} Alyssa P. Hacker wants a
...
\begin{codeBlock}
(set-breakpoint ~\(\langle\kern0.08em \)~~\var{machine}~~\(\rangle \)~ ~\(\langle \)~~\var{label}~~\(\rangle \)~ ~\(\langle \)~~\var{n}~~\(\rangle \)~)
\end{codeBlock}
...
\begin{codeBlock}
(proceed-machine ~\(\langle\kern0.08em \)~~\var{machine}~~\(\rangle \)~)
\end{codeBlock}

She should also be able to remove a specific breakpoint by means of

\begin{codeBlock}
(cancel-breakpoint ~\(\langle\kern0.08em \)~~\var{machine}~~\(\rangle \)~ ~\(\langle \)~~\var{label}~~\(\rangle \)~ ~\(\langle \)~~\var{n}~~\(\rangle \)~)
\end{codeBlock}
...
\begin{codeBlock}
(cancel-all-breakpoints ~\(\langle\kern0.08em \)~~\var{machine}~~\(\rangle \)~)
\end{codeBlock}
\end{exerciseGroup}
...
\begin{imageFigure}
  ...
  \includegraphics[width=91mm]{assets/figures/chapter_5/figure_5.14a.pdf}
\end{imageFigure}
...
\begin{codeBlock}
(assign ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~ (op car) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~))
(assign ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~ (op cdr) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~))
\end{codeBlock}
...
\begin{codeBlock}
(assign ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~ (op vector-ref) (reg the-cars) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~))
(assign ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~ (op vector-ref) (reg the-cdrs) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~))
\end{codeBlock}
...
\begin{codeBlock}
(perform (op set-car!) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~))
(perform (op set-cdr!) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~))
\end{codeBlock}
...
\begin{codeBlock}
(perform
 (op vector-set!) (reg the-cars) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~))
(perform
 (op vector-set!) (reg the-cdrs) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~))
\end{codeBlock}
...
\begin{codeBlock}
(assign ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~ (op cons) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{3}}\rangle \)~))
\end{codeBlock}
...
\begin{codeBlock}
(perform
 (op vector-set!) (reg the-cars) (reg free) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~))
(perform
 (op vector-set!) (reg the-cdrs) (reg free) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{3}}\rangle \)~))
(assign ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~ (reg free))
...
\begin{codeBlock}
(op eq?) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~) (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~)
\end{codeBlock}
...
\begin{codeBlock}
(assign the-stack (op cons) (reg ~\(\langle \)~~\var{reg}~~\(\rangle \)~) (reg the-stack))
\end{codeBlock}
...
\begin{codeBlock}
(assign ~\(\langle \)~~\var{reg}~~\(\rangle \)~ (op car) (reg the-stack))
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.20}Exercise 5.20:} Draw the box-and-pointer
...
\exerciseHeading{\phantomsection\label{Exercise 5.21}Exercise 5.21:} Implement register machines for
...
\exerciseHeading{\phantomsection\label{Exercise 5.22}Exercise 5.22:} \link{Exercise 3.12} of
...
% figure 5.15
\begin{imageFigure}{Reconfiguration of memory by the garbage-collection process.}
  \includegraphics[width=91mm]{assets/figures/chapter_5/figure_5.15a.pdf}
\end{imageFigure}
...
% figure 5.16
\begin{imageFigure}{A silicon-chip implementation of an evaluator for Scheme.}
  \includegraphics[width=91mm]{assets/figures/chapter_5/chip.jpg}
\end{imageFigure}
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.23}Exercise 5.23:} Extend the evaluator to handle
...
\exerciseHeading{\phantomsection\label{Exercise 5.24}Exercise 5.24:} Implement \code{cond} as a new
...
\exerciseHeading{\phantomsection\label{Exercise 5.25}Exercise 5.25:} Modify the evaluator so that it
...
(define eceval
  (make-machine
   ...
   eceval-operations
   '(read-eval-print-loop
     ~\(\langle \)~~\emph{entire machine controller as given above}~~\(\rangle \)~ )))
\end{codeBlock}
...
(define eceval-operations
  (list (list 'self-evaluating? self-evaluating)
        ~\(\langle \)~~\emph{complete list of operations for eceval machine}~~\(\rangle \)~))
\end{codeBlock}
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.26}Exercise 5.26:} Use the monitored stack to
...
\exerciseHeading{\phantomsection\label{Exercise 5.27}Exercise 5.27:} For comparison with \link{Exercise 5.26},
...
\begin{array}{c|c|c}
                 & \text{Maximum depth} & \text{Number of pushes} \\
\hline
\text{Recursive} &                      &                         \\
\text{factorial} &                      &                         \\
\hline
...
\exerciseHeading{\phantomsection\label{Exercise 5.28}Exercise 5.28:} Modify the definition of the
...
\exerciseHeading{\phantomsection\label{Exercise 5.29}Exercise 5.29:} Monitor the stack operations in
...
\exerciseHeading{\phantomsection\label{Exercise 5.30}Exercise 5.30:} Our evaluator currently catches
...
\begin{codeBlock}
(append-instruction-sequences ~\(\langle \)~~\var{seq}~~\(_{\mono{1}}\rangle \)~ ~\(\langle \)~~\var{seq}~~\(_{\mono{2}}\rangle \)~)
\end{codeBlock}
...
\begin{codeBlock}
~\(\langle \)~~\var{seq}~~\(_{\mono{1}}\rangle \)~
~\(\langle \)~~\var{seq}~~\(_{\mono{2}}\rangle \)~
\end{codeBlock}
...
\begin{codeBlock}
(preserving (list ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~ ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~) ~\(\langle \)~~\var{seq}~~\(_{\mono{1}}\rangle \)~ ~\(\langle \)~~\var{seq}~~\(_{\mono{2}}\rangle \)~)
\end{codeBlock}
...
\[
\begin{array}{l|l|l|l}
\langle \mathit{seq}_1 \rangle & \text{\texttt{(save }} \langle \mathit{reg}_1 \rangle \text{\texttt{)}} & \text{\texttt{(save }} \langle \mathit{reg}_2 \rangle \text{\texttt{)}} & \text{\texttt{(save }} \langle \mathit{reg}_2 \rangle \text{\texttt{)}} \\
\langle \mathit{seq}_2 \rangle & \langle \mathit{seq}_1 \rangle                                          & \langle \mathit{seq}_1 \rangle                                          & \text{\texttt{(save }} \langle \mathit{reg}_1 \rangle \text{\texttt{)}} \\
                               & \text{\texttt{(restore }} \langle \mathit{reg}_1 \rangle \text{\texttt{)}}& \text{\texttt{(restore }} \langle \mathit{reg}_2 \rangle \text{\texttt{)}}& \langle \mathit{seq}_1 \rangle                                          \\
                               & \langle \mathit{seq}_2 \rangle                                          & \langle \mathit{seq}_2 \rangle                                          & \text{\texttt{(restore }} \langle \mathit{reg}_1 \rangle \text{\texttt{)}} \\
                               &                                                                        &                                                                        & \text{\texttt{(restore }} \langle \mathit{reg}_2 \rangle \text{\texttt{)}} \\
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.31}Exercise 5.31:} In evaluating a procedure
...
\exerciseHeading{\phantomsection\label{Exercise 5.32}Exercise 5.32:} Using the \code{preserving}
...
\begin{codeBlock}
~\(\langle \)~~\emph{compilation of predicate, target \emph{val}, linkage \emph{next}}~~\(\rangle \)~
 (test (op false?) (reg val))
 (branch (label false-branch))
true-branch
 ~\(\langle \)~~\emph{compilation of consequent with given target}~
  ~\emph{and given linkage or \emph{after-if}}~~\(\rangle \)~
false-branch
 ~\(\langle \)~~\emph{compilation of alternative with given target and linkage}~~\(\rangle \)~
after-if
\end{codeBlock}
...
\begin{codeBlock}
~\(\langle \)~~\emph{construct procedure object and assign it to target register}~~\(\rangle \)~
~\(\langle \)~~\var{linkage}~~\(\rangle \)~
\end{codeBlock}
...
\begin{codeBlock}
~\(\langle \)~~\emph{construct procedure object and assign it to target register}~~\(\rangle \)~
 ~\(\langle \)~~\emph{code for given linkage}~~\(\rangle \)~ ~\emph{or}~ ~\code{(goto (label after\-/lambda))}~
 ~\(\langle \)~~\emph{compilation of procedure body}~~\(\rangle \)~
after-lambda
\end{codeBlock}
...
\begin{codeBlock}
~\(\langle \)~~\emph{compilation of operator, target \emph{proc}, linkage \emph{next}}~~\(\rangle \)~
~\(\langle \)~~\emph{evaluate operands and construct argument list in \emph{argl}}~~\(\rangle \)~
~\(\langle \)~~\emph{compilation of procedure call with given target and linkage}~~\(\rangle \)~
\end{codeBlock}
...
\begin{codeBlock}
~\(\langle \)~~\emph{compilation of last operand, targeted to \emph{val}}~~\(\rangle \)~
(assign argl (op list) (reg val))
~\(\langle \)~~\emph{compilation of next operand, targeted to \emph{val}}~~\(\rangle \)~
(assign argl (op cons) (reg val) (reg argl))
~\( \dots \)~
~\(\langle \)~~\emph{compilation of first operand, targeted to \emph{val}}~~\(\rangle \)~
(assign argl (op cons) (reg val) (reg argl))
\end{codeBlock}
...
compiled-branch
 ~\(\langle \)~~\emph{code to apply compiled procedure with given target}~
  ~\emph{and appropriate linkage}~~\(\rangle \)~
primitive-branch
 (assign ~\(\langle \)~~\var{target}~~\(\rangle \)~
...
(assign continue (label proc-return))
 ...
 (goto (reg val))
proc-return
 (assign ~\(\langle \)~~\var{target}~~\(\rangle \)~ (reg val))   ~\textrm{; included if target is not \code{val}}~
 (goto (label ~\(\langle \)~~\var{linkage}~~\(\rangle \)~))      ~\textrm{; linkage code}~
\end{codeBlock}
...
\begin{codeBlock}
~\(\langle \)~~\emph{set up \emph{continue} for linkage}~~\(\rangle \)~
(assign val (op compiled-procedure-entry) (reg proc))
(goto (reg val))
\end{codeBlock}
...
\begin{codeBlock}
(assign continue (label ~\(\langle \)~~\var{linkage}~~\(\rangle \)~))
(assign val (op compiled-procedure-entry) (reg proc))
(goto (reg val))
\end{codeBlock}
...
\begin{codeBlock}
~\(\langle \)~~\emph{save \emph{env} if modified by code to compute value}~~\(\rangle \)~
  ~\(\langle \)~~\emph{compilation of definition value, target \emph{val}, linkage \emph{next}}~~\(\rangle \)~
  ~\(\langle \)~~\emph{restore \emph{env} if saved above}~~\(\rangle \)~
  (perform (op define-variable!)
           (const factorial)
           (reg val)
           (reg env))
...
\begin{codeBlock}
~\(\langle \)~~\emph{save \emph{continue}, \emph{env} if modified by predicate and needed by branches}~~\(\rangle \)~
  ~\(\langle \)~~\emph{compilation of predicate, target \emph{val}, linkage \emph{next}}~~\(\rangle \)~
  ~\(\langle \)~~\emph{restore \emph{continue}, \emph{env} if saved above}~~\(\rangle \)~
  (test (op false?) (reg val))
  (branch (label false-branch4))
true-branch5
  ~\(\langle \)~~\emph{compilation of true branch, target \emph{val}, linkage \emph{return}}~~\(\rangle \)~
false-branch4
  ~\(\langle \)~~\emph{compilation of false branch, target \emph{val}, linkage \emph{return}}~~\(\rangle \)~
after-if3
\end{codeBlock}
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.33}Exercise 5.33:} Consider the following definition
...
\exerciseHeading{\phantomsection\label{Exercise 5.34}Exercise 5.34:} Compile the iterative factorial
procedure
...
\exerciseHeading{\phantomsection\label{Exercise 5.35}Exercise 5.35:} What expression was compiled to
produce the code shown in \link{Figure 5.18}?

% figure 5.18
\begin{codeFigure}{An example of compiler output. See \link{Exercise 5.35}.}
\begin{compactCodeBlock}
(assign val
        (op make-compiled-procedure)
        (label entry16)
...
\exerciseHeading{\phantomsection\label{Exercise 5.36}Exercise 5.36:} What order of evaluation does our
...
\exerciseHeading{\phantomsection\label{Exercise 5.37}Exercise 5.37:} One way to understand the
...
\exerciseHeading{\phantomsection\label{Exercise 5.38}Exercise 5.38:} Our compiler is clever about
...
((lambda (x y)
   (lambda (a b c d e)
     ((lambda (y z) ~\(\langle \)~~\var{e1}~~\(\rangle \)~)
      ~\(\langle \)~~\var{e2}~~\(\rangle \)~
      (+ c d x))))
 3
 4)
\end{codeBlock}
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.39}Exercise 5.39:} Write a procedure
...
\exerciseHeading{\phantomsection\label{Exercise 5.40}Exercise 5.40:} Modify the compiler to maintain
...
\exerciseHeading{\phantomsection\label{Exercise 5.41}Exercise 5.41:} Write a procedure
...
\exerciseHeading{\phantomsection\label{Exercise 5.42}Exercise 5.42:} Using \code{find\-/variable} from
...
\exerciseHeading{\phantomsection\label{Exercise 5.43}Exercise 5.43:} We argued in \link{Section 4.1.6}
...
\exerciseHeading{\phantomsection\label{Exercise 5.44}Exercise 5.44:} In this section we have focused
...
\begin{exerciseGroup}
\exerciseHeading{\phantomsection\label{Exercise 5.45}Exercise 5.45:} By comparing the stack operations
...
\exerciseHeading{\phantomsection\label{Exercise 5.46}Exercise 5.46:} Carry out an analysis like the
...
\exerciseHeading{\phantomsection\label{Exercise 5.47}Exercise 5.47:} This section described how to
...
\exerciseHeading{\phantomsection\label{Exercise 5.48}Exercise 5.48:} The \code{compile\-/and\-/go}
...
\exerciseHeading{\phantomsection\label{Exercise 5.49}Exercise 5.49:} As an alternative to using the
...
\exerciseHeading{\phantomsection\label{Exercise 5.50}Exercise 5.50:} Use the compiler to compile the
...
\exerciseHeading{\phantomsection\label{Exercise 5.51}Exercise 5.51:} Develop a rudimentary
...
\exerciseHeading{\phantomsection\label{Exercise 5.52}Exercise 5.52:} As a counterpoint to

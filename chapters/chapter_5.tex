...
(define (get-register-contents machine
                               register-name)
  (get-contents (get-register machine
                              register-name)))
(define (set-register-contents! machine
                                register-name
                                value)
  (set-contents! (get-register
                   machine
                   register-name)
                 value)
  'done)
...
\begin{codeBlock}
(assign ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~
        (op vector-ref)
        (reg the-cars)
        (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~))
(assign ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~
        (op vector-ref)
        (reg the-cdrs)
        (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~))
...
(perform (op vector-set!)
         (reg the-cars)
         (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~)
         (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{2}}\rangle \)~))
(perform (op vector-set!)
         (reg the-cdrs)
         (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{1}}\rangle \)~)
...
(perform (op vector-set!)
         (reg the-cdrs)
         (reg free)
         (reg ~\(\langle \)~~\var{reg}~~\(_{\mono{3}}\rangle \)~))

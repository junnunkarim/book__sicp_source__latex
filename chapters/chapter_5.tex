...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.1}
\exerciseHeading{Exercise 5.1:} Design a register machine to
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.2}
\exerciseHeading{Exercise 5.2:} Use the register-machine language
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.3}
\exerciseHeading{Exercise 5.3:} Design a machine to compute square
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.4}
\exerciseHeading{Exercise 5.4:} Specify register machines that
...
\phantomsection\label{Exercise 5.5}
\exerciseHeading{Exercise 5.5:} Hand-simulate the factorial and
...
\phantomsection\label{Exercise 5.6}
\exerciseHeading{Exercise 5.6:} Ben Bitdiddle observes that the
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.7}
\exerciseHeading{Exercise 5.7:} Use the simulator to test the
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.8}
\exerciseHeading{Exercise 5.8:} The following register-machine code
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.9}
\exerciseHeading{Exercise 5.9:} The treatment of machine operations
...
\phantomsection\label{Exercise 5.10}
\exerciseHeading{Exercise 5.10:} Design a new syntax for
...
\phantomsection\label{Exercise 5.11}
\exerciseHeading{Exercise 5.11:} When we introduced \code{save}
...
\phantomsection\label{Exercise 5.12}
\exerciseHeading{Exercise 5.12:} The simulator can be used to help
...
\phantomsection\label{Exercise 5.13}
\exerciseHeading{Exercise 5.13:} Modify the simulator so that it
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.14}
\exerciseHeading{Exercise 5.14:} Measure the number of pushes and
...
\phantomsection\label{Exercise 5.15}
\exerciseHeading{Exercise 5.15:} Add \newterm{instruction
...
\phantomsection\label{Exercise 5.16}
\exerciseHeading{Exercise 5.16:} Augment the simulator to provide
...
\phantomsection\label{Exercise 5.17}
\exerciseHeading{Exercise 5.17:} Extend the instruction tracing of
...
\phantomsection\label{Exercise 5.18}
\exerciseHeading{Exercise 5.18:} Modify the \code{make\-/register}
...
\phantomsection\label{Exercise 5.19}
\exerciseHeading{Exercise 5.19:} Alyssa P. Hacker wants a
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.20}
\exerciseHeading{Exercise 5.20:} Draw the box-and-pointer
...
\phantomsection\label{Exercise 5.21}
\exerciseHeading{Exercise 5.21:} Implement register machines for
...
\phantomsection\label{Exercise 5.22}
\exerciseHeading{Exercise 5.22:} \link{Exercise 3.12} of
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.23}
\exerciseHeading{Exercise 5.23:} Extend the evaluator to handle
...
\phantomsection\label{Exercise 5.24}
\exerciseHeading{Exercise 5.24:} Implement \code{cond} as a new
...
\phantomsection\label{Exercise 5.25}
\exerciseHeading{Exercise 5.25:} Modify the evaluator so that it
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.26}
\exerciseHeading{Exercise 5.26:} Use the monitored stack to
...
\phantomsection\label{Exercise 5.27}
\exerciseHeading{Exercise 5.27:} For comparison with \link{Exercise 5.26},
...
\phantomsection\label{Exercise 5.28}
\exerciseHeading{Exercise 5.28:} Modify the definition of the
...
\phantomsection\label{Exercise 5.29}
\exerciseHeading{Exercise 5.29:} Monitor the stack operations in
...
\phantomsection\label{Exercise 5.30}
\exerciseHeading{Exercise 5.30:} Our evaluator currently catches
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.31}
\exerciseHeading{Exercise 5.31:} In evaluating a procedure
...
\phantomsection\label{Exercise 5.32}
\exerciseHeading{Exercise 5.32:} Using the \code{preserving}
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.33}
\exerciseHeading{Exercise 5.33:} Consider the following definition
...
\phantomsection\label{Exercise 5.34}
\exerciseHeading{Exercise 5.34:} Compile the iterative factorial
procedure
...
\phantomsection\label{Exercise 5.35}
\exerciseHeading{Exercise 5.35:} What expression was compiled to
...
\phantomsection\label{Exercise 5.36}
\exerciseHeading{Exercise 5.36:} What order of evaluation does our
...
\phantomsection\label{Exercise 5.37}
\exerciseHeading{Exercise 5.37:} One way to understand the
...
\phantomsection\label{Exercise 5.38}
\exerciseHeading{Exercise 5.38:} Our compiler is clever about
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.39}
\exerciseHeading{Exercise 5.39:} Write a procedure
...
\phantomsection\label{Exercise 5.40}
\exerciseHeading{Exercise 5.40:} Modify the compiler to maintain
...
\phantomsection\label{Exercise 5.41}
\exerciseHeading{Exercise 5.41:} Write a procedure
...
\phantomsection\label{Exercise 5.42}
\exerciseHeading{Exercise 5.42:} Using \code{find\-/variable} from
...
\phantomsection\label{Exercise 5.43}
\exerciseHeading{Exercise 5.43:} We argued in \link{Section 4.1.6}
...
\phantomsection\label{Exercise 5.44}
\exerciseHeading{Exercise 5.44:} In this section we have focused
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 5.45}
\exerciseHeading{Exercise 5.45:} By comparing the stack operations
...
\phantomsection\label{Exercise 5.46}
\exerciseHeading{Exercise 5.46:} Carry out an analysis like the
...
\phantomsection\label{Exercise 5.47}
\exerciseHeading{Exercise 5.47:} This section described how to
...
\phantomsection\label{Exercise 5.48}
\exerciseHeading{Exercise 5.48:} The \code{compile\-/and\-/go}
...
\phantomsection\label{Exercise 5.49}
\exerciseHeading{Exercise 5.49:} As an alternative to using the
...
\phantomsection\label{Exercise 5.50}
\exerciseHeading{Exercise 5.50:} Use the compiler to compile the
...
\phantomsection\label{Exercise 5.51}
\exerciseHeading{Exercise 5.51:} Develop a rudimentary
...
\phantomsection\label{Exercise 5.52}
\exerciseHeading{Exercise 5.52:} As a counterpoint to
